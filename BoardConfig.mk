...
# Kernel
TARGET_KERNEL_SOURCE := kernel/htc/endeavortd
...
TARGET_RECOVERY_FSTAB := device/htc/endeavortd/ramdisk/fstab.endeavortd
...
# Releasetools
TARGET_RELEASETOOLS_EXTENSIONS := device/htc/endeavortd

# Device specific SELinux policies
BOARD_SEPOLICY_DIRS += \
    device/htc/endeavortd/selinux
